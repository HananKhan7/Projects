"""
Project: Personalized Toxicity Detection Using Meta-Llama-3-8B and User Profiles

Description:
This project aims to enhance the accuracy and personalization of toxicity classification by utilizing the Meta-Llama-3-8B model.
...
Key Features:
- Utilizes LLAMA3 8B model for toxicity classification.
...
- Feeds the contextual information into the LLAMA3 8B model.
...
def predict_toxicity(comment, primary_profile, secondary_profiles, primary_train_data, secondary_train_data_list):
    ...
    prompt: f"""
        ...
        Only respond with the single numerical rating of either 0,1,2,3 or 4. Do not provide explanations, empty strings or notes. 
        If the toxicity is unclear, return the numerical score 0. Do not provide any alphabets or symbols. 
